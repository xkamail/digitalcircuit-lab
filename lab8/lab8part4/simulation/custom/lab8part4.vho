...
-- Equation(s):
-- \h1|hex[5]~0_combout\ = ( \sw[7]~input_o\ & ( \sw[4]~input_o\ & ( (\sw[6]~input_o\ & !\sw[5]~input_o\) ) ) ) # ( !\sw[7]~input_o\ & ( \sw[4]~input_o\ & ( (!\sw[6]~input_o\) # (\sw[5]~input_o\) ) ) ) # ( !\sw[7]~input_o\ & ( !\sw[4]~input_o\ & ( 
...
-- Equation(s):
-- \h1|hex[4]~1_combout\ = ( !\sw[7]~input_o\ & ( \sw[5]~input_o\ & ( \sw[4]~input_o\ ) ) ) # ( \sw[7]~input_o\ & ( !\sw[5]~input_o\ & ( (\sw[4]~input_o\ & !\sw[6]~input_o\) ) ) ) # ( !\sw[7]~input_o\ & ( !\sw[5]~input_o\ & ( (\sw[6]~input_o\) # 
-- (\sw[4]~input_o\) ) ) )
...
-- Equation(s):
-- \h1|hex[3]~2_combout\ = ( \sw[7]~input_o\ & ( \sw[4]~input_o\ & ( (\sw[6]~input_o\ & \sw[5]~input_o\) ) ) ) # ( !\sw[7]~input_o\ & ( \sw[4]~input_o\ & ( !\sw[6]~input_o\ $ (\sw[5]~input_o\) ) ) ) # ( \sw[7]~input_o\ & ( !\sw[4]~input_o\ & ( 
...
-- Equation(s):
-- \h1|hex[2]~3_combout\ = ( \sw[7]~input_o\ & ( \sw[4]~input_o\ & ( (\sw[6]~input_o\ & \sw[5]~input_o\) ) ) ) # ( \sw[7]~input_o\ & ( !\sw[4]~input_o\ & ( \sw[6]~input_o\ ) ) ) # ( !\sw[7]~input_o\ & ( !\sw[4]~input_o\ & ( (!\sw[6]~input_o\ & 
-- \sw[5]~input_o\) ) ) )
...
-- Equation(s):
-- \h1|hex[1]~4_combout\ = ( \sw[7]~input_o\ & ( \sw[5]~input_o\ & ( (\sw[6]~input_o\) # (\sw[4]~input_o\) ) ) ) # ( !\sw[7]~input_o\ & ( \sw[5]~input_o\ & ( (!\sw[4]~input_o\ & \sw[6]~input_o\) ) ) ) # ( \sw[7]~input_o\ & ( !\sw[5]~input_o\ & ( 
...
-- Equation(s):
-- \h1|hex[0]~5_combout\ = ( \sw[7]~input_o\ & ( \sw[4]~input_o\ & ( !\sw[6]~input_o\ $ (!\sw[5]~input_o\) ) ) ) # ( !\sw[7]~input_o\ & ( \sw[4]~input_o\ & ( (!\sw[6]~input_o\ & !\sw[5]~input_o\) ) ) ) # ( !\sw[7]~input_o\ & ( !\sw[4]~input_o\ & ( 
-- (\sw[6]~input_o\ & !\sw[5]~input_o\) ) ) )
...
-- Equation(s):
-- \u0|i~0_combout\ = ( !\u0|i[0]~DUPLICATE_q\ & ( !\u0|i\(1) ) )
...
-- Equation(s):
-- \u0|Equal0~0_combout\ = ( \u0|i\(1) & ( \u0|i\(0) ) )
...
-- pragma translate_on
PORT MAP (
	datac => \u0|ALT_INV_i\(0),
	dataf => \u0|ALT_INV_i\(1),
...
-- Equation(s):
-- \u1|v~3_combout\ = ( !\u1|rollover_v~q\ & ( !\u1|v\(2) $ (((!\u1|v[0]~DUPLICATE_q\) # (!\u1|v\(1)))) ) )
...
-- Equation(s):
-- \u1|v~2_combout\ = ( \u1|v\(3) & ( \u1|v\(1) & ( (!\u1|rollover_v~q\ & ((!\u1|v[0]~DUPLICATE_q\) # (!\u1|v[2]~DUPLICATE_q\))) ) ) ) # ( !\u1|v\(3) & ( \u1|v\(1) & ( (!\u1|rollover_v~q\ & (\u1|v[0]~DUPLICATE_q\ & \u1|v[2]~DUPLICATE_q\)) ) ) ) # ( \u1|v\(3) 
-- & ( !\u1|v\(1) & ( !\u1|rollover_v~q\ ) ) )
...
-- Equation(s):
-- \u1|rollover_v~0_combout\ = ( \u1|v[3]~DUPLICATE_q\ & ( (\u1|v[2]~DUPLICATE_q\ & \u1|v\(4)) ) )
...
PORT MAP (
	...
	datad => \u1|ALT_INV_v\(4),
	dataf => \u1|ALT_INV_v[3]~DUPLICATE_q\,
	combout => \u1|rollover_v~0_combout\);

-- Location: MLABCELL_X37_Y1_N42
\u1|rollover_v~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \u1|rollover_v~1_combout\ = ( \u1|rollover_v~q\ & ( \u1|rollover_v~0_combout\ & ( (!\u0|trig~q\) # (((!\u1|v[0]~DUPLICATE_q\ & \u1|v\(1))) # (\key0~input_o\)) ) ) ) # ( !\u1|rollover_v~q\ & ( \u1|rollover_v~0_combout\ & ( (\u0|trig~q\ & (!\key0~input_o\ & 
-- (!\u1|v[0]~DUPLICATE_q\ & \u1|v\(1)))) ) ) ) # ( \u1|rollover_v~q\ & ( !\u1|rollover_v~0_combout\ & ( (!\u0|trig~q\) # (\key0~input_o\) ) ) )
...
-- Equation(s):
-- \u1|v~0_combout\ = ( \u1|v\(4) & ( \u1|v\(2) & ( (!\u1|rollover_v~q\ & ((!\u1|v[0]~DUPLICATE_q\) # ((!\u1|v[3]~DUPLICATE_q\) # (!\u1|v\(1))))) ) ) ) # ( !\u1|v\(4) & ( \u1|v\(2) & ( (\u1|v[0]~DUPLICATE_q\ & (!\u1|rollover_v~q\ & (\u1|v[3]~DUPLICATE_q\ & 
-- \u1|v\(1)))) ) ) ) # ( \u1|v\(4) & ( !\u1|v\(2) & ( !\u1|rollover_v~q\ ) ) )
...
PORT MAP (
	dataa => \u1|ALT_INV_v[0]~DUPLICATE_q\,
	datab => \u1|ALT_INV_rollover_v~q\,
	datac => \u1|ALT_INV_v[3]~DUPLICATE_q\,
	datad => \u1|ALT_INV_v\(1),
...
-- Equation(s):
-- \h3|hex\(6) = ( \u1|v\(2) & ( (!\u1|v[0]~DUPLICATE_q\ & (!\u1|v\(1) & \u1|v[3]~DUPLICATE_q\)) # (\u1|v[0]~DUPLICATE_q\ & (\u1|v\(1) & !\u1|v[3]~DUPLICATE_q\)) ) ) # ( !\u1|v\(2) & ( (!\u1|v\(1) & !\u1|v[3]~DUPLICATE_q\) ) )
...
-- Equation(s):
-- \h3|hex[5]~0_combout\ = ( \u1|v\(0) & ( !\u1|v[3]~DUPLICATE_q\ $ (((\u1|v[2]~DUPLICATE_q\ & !\u1|v\(1)))) ) ) # ( !\u1|v\(0) & ( (!\u1|v[3]~DUPLICATE_q\ & (!\u1|v[2]~DUPLICATE_q\ & \u1|v\(1))) ) )
...
PORT MAP (
	...
	datab => \u1|ALT_INV_v[2]~DUPLICATE_q\,
	datac => \u1|ALT_INV_v\(1),
...
-- Equation(s):
-- \h3|hex[4]~1_combout\ = ( \u1|v\(1) & ( (!\u1|v[3]~DUPLICATE_q\ & \u1|v[0]~DUPLICATE_q\) ) ) # ( !\u1|v\(1) & ( (!\u1|v[2]~DUPLICATE_q\ & ((\u1|v[0]~DUPLICATE_q\))) # (\u1|v[2]~DUPLICATE_q\ & (!\u1|v[3]~DUPLICATE_q\)) ) )
...
-- Equation(s):
-- \h3|hex[3]~2_combout\ = ( \u1|v\(0) & ( (!\u1|v[2]~DUPLICATE_q\ & (!\u1|v[3]~DUPLICATE_q\ & !\u1|v\(1))) # (\u1|v[2]~DUPLICATE_q\ & ((\u1|v\(1)))) ) ) # ( !\u1|v\(0) & ( (!\u1|v[3]~DUPLICATE_q\ & (\u1|v[2]~DUPLICATE_q\ & !\u1|v\(1))) # 
-- (\u1|v[3]~DUPLICATE_q\ & (!\u1|v[2]~DUPLICATE_q\ & \u1|v\(1))) ) )
...
-- Equation(s):
-- \h3|hex[2]~3_combout\ = ( \u1|v\(0) & ( (\u1|v[3]~DUPLICATE_q\ & (\u1|v\(1) & \u1|v\(2))) ) ) # ( !\u1|v\(0) & ( (!\u1|v[3]~DUPLICATE_q\ & (\u1|v\(1) & !\u1|v\(2))) # (\u1|v[3]~DUPLICATE_q\ & ((\u1|v\(2)))) ) )
...
-- Equation(s):
-- \h3|hex[1]~4_combout\ = ( \u1|v\(0) & ( (!\u1|v[3]~DUPLICATE_q\ & (\u1|v[2]~DUPLICATE_q\ & !\u1|v\(1))) # (\u1|v[3]~DUPLICATE_q\ & ((\u1|v\(1)))) ) ) # ( !\u1|v\(0) & ( (\u1|v[2]~DUPLICATE_q\ & ((\u1|v\(1)) # (\u1|v[3]~DUPLICATE_q\))) ) )
...
-- Equation(s):
-- \h3|hex[0]~5_combout\ = ( \u1|v\(1) & ( (\u1|v[0]~DUPLICATE_q\ & (\u1|v\(3) & !\u1|v\(2))) ) ) # ( !\u1|v\(1) & ( (!\u1|v[0]~DUPLICATE_q\ & (!\u1|v\(3) & \u1|v\(2))) # (\u1|v[0]~DUPLICATE_q\ & (!\u1|v\(3) $ (\u1|v\(2)))) ) )
...
-- Equation(s):
-- \h5|hex\(6) = ( !\ram0|altsyncram_component|auto_generated|q_b\(1) & ( \ram0|altsyncram_component|auto_generated|q_b\(3) & ( (\ram0|altsyncram_component|auto_generated|q_b\(2) & !\ram0|altsyncram_component|auto_generated|q_b\(0)) ) ) ) # ( 
-- \ram0|altsyncram_component|auto_generated|q_b\(1) & ( !\ram0|altsyncram_component|auto_generated|q_b\(3) & ( (\ram0|altsyncram_component|auto_generated|q_b\(2) & \ram0|altsyncram_component|auto_generated|q_b\(0)) ) ) ) # ( 
-- !\ram0|altsyncram_component|auto_generated|q_b\(1) & ( !\ram0|altsyncram_component|auto_generated|q_b\(3) & ( !\ram0|altsyncram_component|auto_generated|q_b\(2) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1100110011001100000000000011001100110011000000000000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \h5|hex[5]~0_combout\ = ( !\ram0|altsyncram_component|auto_generated|q_b\(1) & ( \ram0|altsyncram_component|auto_generated|q_b\(3) & ( (\ram0|altsyncram_component|auto_generated|q_b\(0) & \ram0|altsyncram_component|auto_generated|q_b\(2)) ) ) ) # ( 
-- \ram0|altsyncram_component|auto_generated|q_b\(1) & ( !\ram0|altsyncram_component|auto_generated|q_b\(3) & ( (!\ram0|altsyncram_component|auto_generated|q_b\(2)) # (\ram0|altsyncram_component|auto_generated|q_b\(0)) ) ) ) # ( 
-- !\ram0|altsyncram_component|auto_generated|q_b\(1) & ( !\ram0|altsyncram_component|auto_generated|q_b\(3) & ( (\ram0|altsyncram_component|auto_generated|q_b\(0) & !\ram0|altsyncram_component|auto_generated|q_b\(2)) ) ) )
...
-- Equation(s):
-- \h5|hex[4]~1_combout\ = ( !\ram0|altsyncram_component|auto_generated|q_b\(1) & ( \ram0|altsyncram_component|auto_generated|q_b\(3) & ( (!\ram0|altsyncram_component|auto_generated|q_b\(2) & \ram0|altsyncram_component|auto_generated|q_b\(0)) ) ) ) # ( 
-- \ram0|altsyncram_component|auto_generated|q_b\(1) & ( !\ram0|altsyncram_component|auto_generated|q_b\(3) & ( \ram0|altsyncram_component|auto_generated|q_b\(0) ) ) ) # ( !\ram0|altsyncram_component|auto_generated|q_b\(1) & ( 
-- !\ram0|altsyncram_component|auto_generated|q_b\(3) & ( (\ram0|altsyncram_component|auto_generated|q_b\(0)) # (\ram0|altsyncram_component|auto_generated|q_b\(2)) ) ) )
...
-- Equation(s):
-- \h5|hex[3]~2_combout\ = ( \ram0|altsyncram_component|auto_generated|q_b\(1) & ( \ram0|altsyncram_component|auto_generated|q_b\(3) & ( !\ram0|altsyncram_component|auto_generated|q_b\(0) $ (\ram0|altsyncram_component|auto_generated|q_b\(2)) ) ) ) # ( 
-- \ram0|altsyncram_component|auto_generated|q_b\(1) & ( !\ram0|altsyncram_component|auto_generated|q_b\(3) & ( (\ram0|altsyncram_component|auto_generated|q_b\(0) & \ram0|altsyncram_component|auto_generated|q_b\(2)) ) ) ) # ( 
-- !\ram0|altsyncram_component|auto_generated|q_b\(1) & ( !\ram0|altsyncram_component|auto_generated|q_b\(3) & ( !\ram0|altsyncram_component|auto_generated|q_b\(0) $ (!\ram0|altsyncram_component|auto_generated|q_b\(2)) ) ) )
...
-- Equation(s):
-- \h5|hex[2]~3_combout\ = ( \ram0|altsyncram_component|auto_generated|q_b\(1) & ( \ram0|altsyncram_component|auto_generated|q_b\(3) & ( \ram0|altsyncram_component|auto_generated|q_b\(2) ) ) ) # ( !\ram0|altsyncram_component|auto_generated|q_b\(1) & ( 
-- \ram0|altsyncram_component|auto_generated|q_b\(3) & ( (\ram0|altsyncram_component|auto_generated|q_b\(2) & !\ram0|altsyncram_component|auto_generated|q_b\(0)) ) ) ) # ( \ram0|altsyncram_component|auto_generated|q_b\(1) & ( 
-- !\ram0|altsyncram_component|auto_generated|q_b\(3) & ( (!\ram0|altsyncram_component|auto_generated|q_b\(2) & !\ram0|altsyncram_component|auto_generated|q_b\(0)) ) ) )
...
-- Equation(s):
-- \h5|hex[1]~4_combout\ = ( \ram0|altsyncram_component|auto_generated|q_b\(1) & ( \ram0|altsyncram_component|auto_generated|q_b\(3) & ( (\ram0|altsyncram_component|auto_generated|q_b\(2)) # (\ram0|altsyncram_component|auto_generated|q_b\(0)) ) ) ) # ( 
-- !\ram0|altsyncram_component|auto_generated|q_b\(1) & ( \ram0|altsyncram_component|auto_generated|q_b\(3) & ( (!\ram0|altsyncram_component|auto_generated|q_b\(0) & \ram0|altsyncram_component|auto_generated|q_b\(2)) ) ) ) # ( 
-- \ram0|altsyncram_component|auto_generated|q_b\(1) & ( !\ram0|altsyncram_component|auto_generated|q_b\(3) & ( (!\ram0|altsyncram_component|auto_generated|q_b\(0) & \ram0|altsyncram_component|auto_generated|q_b\(2)) ) ) ) # ( 
-- !\ram0|altsyncram_component|auto_generated|q_b\(1) & ( !\ram0|altsyncram_component|auto_generated|q_b\(3) & ( (\ram0|altsyncram_component|auto_generated|q_b\(0) & \ram0|altsyncram_component|auto_generated|q_b\(2)) ) ) )
...
-- Equation(s):
-- \h5|hex[0]~5_combout\ = ( \ram0|altsyncram_component|auto_generated|q_b\(1) & ( \ram0|altsyncram_component|auto_generated|q_b\(3) & ( (!\ram0|altsyncram_component|auto_generated|q_b\(2) & \ram0|altsyncram_component|auto_generated|q_b\(0)) ) ) ) # ( 
-- !\ram0|altsyncram_component|auto_generated|q_b\(1) & ( \ram0|altsyncram_component|auto_generated|q_b\(3) & ( (\ram0|altsyncram_component|auto_generated|q_b\(2) & \ram0|altsyncram_component|auto_generated|q_b\(0)) ) ) ) # ( 
-- !\ram0|altsyncram_component|auto_generated|q_b\(1) & ( !\ram0|altsyncram_component|auto_generated|q_b\(3) & ( !\ram0|altsyncram_component|auto_generated|q_b\(2) $ (!\ram0|altsyncram_component|auto_generated|q_b\(0)) ) ) )
