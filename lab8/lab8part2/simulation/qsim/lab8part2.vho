...
-- d_out[0]	=>  Location: PIN_AB18,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- d_out[1]	=>  Location: PIN_Y16,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- d_out[2]	=>  Location: PIN_Y17,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- d_out[3]	=>  Location: PIN_V15,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- pragma translate_on
PORT MAP (
	i => \memory_array_rtl_0|auto_generated|ram_block1a0~portbdataout\,
	devoe => ww_devoe,
	o => ww_d_out(0));
...
-- pragma translate_on
PORT MAP (
	i => \memory_array_rtl_0|auto_generated|ram_block1a1\,
	devoe => ww_devoe,
	o => ww_d_out(1));
...
-- pragma translate_on
PORT MAP (
	i => \memory_array_rtl_0|auto_generated|ram_block1a2\,
	devoe => ww_devoe,
	o => ww_d_out(2));
...
-- pragma translate_on
PORT MAP (
	i => \memory_array_rtl_0|auto_generated|ram_block1a3\,
	devoe => ww_devoe,
	o => ww_d_out(3));
...
-- Equation(s):
-- \h1|hex\(6) = ( \sw[5]~input_o\ & ( (!\sw[7]~input_o\ & (\sw[4]~input_o\ & \sw[6]~input_o\)) ) ) # ( !\sw[5]~input_o\ & ( (!\sw[7]~input_o\ & ((!\sw[6]~input_o\))) # (\sw[7]~input_o\ & (!\sw[4]~input_o\ & \sw[6]~input_o\)) ) )
...
-- Equation(s):
-- \h1|hex[5]~0_combout\ = ( \sw[5]~input_o\ & ( (!\sw[7]~input_o\ & ((!\sw[6]~input_o\) # (\sw[4]~input_o\))) ) ) # ( !\sw[5]~input_o\ & ( (\sw[4]~input_o\ & (!\sw[6]~input_o\ $ (\sw[7]~input_o\))) ) )
...
-- Equation(s):
-- \h1|hex[3]~2_combout\ = ( \sw[5]~input_o\ & ( (!\sw[6]~input_o\ & (!\sw[4]~input_o\ & \sw[7]~input_o\)) # (\sw[6]~input_o\ & (\sw[4]~input_o\)) ) ) # ( !\sw[5]~input_o\ & ( (!\sw[7]~input_o\ & (!\sw[6]~input_o\ $ (!\sw[4]~input_o\))) ) )
...
-- Equation(s):
-- \h1|hex[2]~3_combout\ = ( \sw[5]~input_o\ & ( (!\sw[7]~input_o\ & (!\sw[4]~input_o\ & !\sw[6]~input_o\)) # (\sw[7]~input_o\ & ((\sw[6]~input_o\))) ) ) # ( !\sw[5]~input_o\ & ( (\sw[7]~input_o\ & (!\sw[4]~input_o\ & \sw[6]~input_o\)) ) )
...
-- Equation(s):
-- \h1|hex[0]~5_combout\ = ( \sw[5]~input_o\ & ( (\sw[7]~input_o\ & (\sw[4]~input_o\ & !\sw[6]~input_o\)) ) ) # ( !\sw[5]~input_o\ & ( (!\sw[7]~input_o\ & (!\sw[4]~input_o\ $ (!\sw[6]~input_o\))) # (\sw[7]~input_o\ & (\sw[4]~input_o\ & \sw[6]~input_o\)) ) )
...
-- Equation(s):
-- \h3|hex\(6) = ( !\sw[1]~input_o\ & ( \sw[3]~input_o\ & ( (!\sw[0]~input_o\ & \sw[2]~input_o\) ) ) ) # ( \sw[1]~input_o\ & ( !\sw[3]~input_o\ & ( (\sw[0]~input_o\ & \sw[2]~input_o\) ) ) ) # ( !\sw[1]~input_o\ & ( !\sw[3]~input_o\ & ( !\sw[2]~input_o\ ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111111100000000000000000101010100000000101010100000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \h3|hex[5]~0_combout\ = ( !\sw[1]~input_o\ & ( \sw[3]~input_o\ & ( (\sw[2]~input_o\ & \sw[0]~input_o\) ) ) ) # ( \sw[1]~input_o\ & ( !\sw[3]~input_o\ & ( (!\sw[2]~input_o\) # (\sw[0]~input_o\) ) ) ) # ( !\sw[1]~input_o\ & ( !\sw[3]~input_o\ & ( 
...
-- Equation(s):
-- \h3|hex[4]~1_combout\ = ( !\sw[1]~input_o\ & ( \sw[3]~input_o\ & ( (!\sw[2]~input_o\ & \sw[0]~input_o\) ) ) ) # ( \sw[1]~input_o\ & ( !\sw[3]~input_o\ & ( \sw[0]~input_o\ ) ) ) # ( !\sw[1]~input_o\ & ( !\sw[3]~input_o\ & ( (\sw[0]~input_o\) # 
-- (\sw[2]~input_o\) ) ) )
...
-- Equation(s):
-- \h3|hex[3]~2_combout\ = ( \sw[1]~input_o\ & ( \sw[3]~input_o\ & ( !\sw[0]~input_o\ $ (\sw[2]~input_o\) ) ) ) # ( \sw[1]~input_o\ & ( !\sw[3]~input_o\ & ( (\sw[0]~input_o\ & \sw[2]~input_o\) ) ) ) # ( !\sw[1]~input_o\ & ( !\sw[3]~input_o\ & ( 
...
-- Equation(s):
-- \h3|hex[2]~3_combout\ = ( \sw[1]~input_o\ & ( \sw[3]~input_o\ & ( \sw[2]~input_o\ ) ) ) # ( !\sw[1]~input_o\ & ( \sw[3]~input_o\ & ( (\sw[2]~input_o\ & !\sw[0]~input_o\) ) ) ) # ( \sw[1]~input_o\ & ( !\sw[3]~input_o\ & ( (!\sw[2]~input_o\ & 
-- !\sw[0]~input_o\) ) ) )
...
-- Equation(s):
-- \h3|hex[1]~4_combout\ = ( \sw[1]~input_o\ & ( \sw[3]~input_o\ & ( (\sw[2]~input_o\) # (\sw[0]~input_o\) ) ) ) # ( !\sw[1]~input_o\ & ( \sw[3]~input_o\ & ( (!\sw[0]~input_o\ & \sw[2]~input_o\) ) ) ) # ( \sw[1]~input_o\ & ( !\sw[3]~input_o\ & ( 
...
-- Equation(s):
-- \h3|hex[0]~5_combout\ = ( \sw[2]~input_o\ & ( (!\sw[1]~input_o\ & (!\sw[3]~input_o\ $ (\sw[0]~input_o\))) ) ) # ( !\sw[2]~input_o\ & ( (\sw[0]~input_o\ & (!\sw[3]~input_o\ $ (\sw[1]~input_o\))) ) )
...
PORT MAP (
	...
	datac => \memory_array_rtl_0|auto_generated|ALT_INV_ram_block1a1\,
	datad => \memory_array_rtl_0|auto_generated|ALT_INV_ram_block1a3\,
	dataf => \memory_array_rtl_0|auto_generated|ALT_INV_ram_block1a0~portbdataout\,
	combout => \h4|hex\(6));
...
PORT MAP (
	dataa => \memory_array_rtl_0|auto_generated|ALT_INV_ram_block1a2\,
	datab => \memory_array_rtl_0|auto_generated|ALT_INV_ram_block1a1\,
	datad => \memory_array_rtl_0|auto_generated|ALT_INV_ram_block1a3\,
	dataf => \memory_array_rtl_0|auto_generated|ALT_INV_ram_block1a0~portbdataout\,
	combout => \h4|hex\(5));
...
-- Equation(s):
-- \h4|hex[0]~3_combout\ = ( \memory_array_rtl_0|auto_generated|ram_block1a0~portbdataout\ & ( (!\memory_array_rtl_0|auto_generated|ram_block1a2\ & (!\memory_array_rtl_0|auto_generated|ram_block1a1\ $ (\memory_array_rtl_0|auto_generated|ram_block1a3\))) # 
-- (\memory_array_rtl_0|auto_generated|ram_block1a2\ & (!\memory_array_rtl_0|auto_generated|ram_block1a1\ & \memory_array_rtl_0|auto_generated|ram_block1a3\)) ) ) # ( !\memory_array_rtl_0|auto_generated|ram_block1a0~portbdataout\ & ( 
